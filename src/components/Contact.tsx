        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:scale-105 transition-transform duration-200 shadow-lg"
              >
                <Send size={20} />
          ...
          <div className="space-y-8">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    key={index}
                    href={social.href}
                    className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-200"
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
              ...
              <p className="mb-6">
                I'm currently available for freelance work and exciting mobile app projects. 
